...
<head>
    ...
    <style>
        ...
        * { padding: 0; margin: 0; box-sizing: border-box; }
        ...
        nav {
            width: 90%; height: 17vh; display: flex; justify-content: space-around;
            align-items: center; position: relative; left: 100px;
        }
        nav a { text-decoration: none; font-size: 1.6rem; color: #a58e7c; }
        nav a:hover { scale: 1.1; }
        span { color: #f21b3f; }
        button { padding: 7px 30px; background-color: #f21b3f; color: white; border: none; }
        .add {
            text-decoration: none; color: white; padding: 8px 20px; text-align: center;
            background-color: #a58e7c; border: 3px solid #a58e7c; position: relative;
        ...
        a { text-decoration: none; padding: 8px 20px; color: white; }
        .edit { background-color: lightseagreen; margin: 25px; padding: 5px 15px; }
        .delete { background-color: lightcoral; padding: 5px 15px; }
        h1 {
        ...
        .search-container {
            position: relative; top: 60px; left: 550px; width: 40%;
        }
        .search-container input {
            padding: 10px 20px; background-color: #E8F0FE; border: none;
            color: #1f2327; font-size: 20px; outline: none;
        }
        .search-container input[type='submit'] {
            padding: 10.5px 20px; margin-left: -3px; background-color: #f21b3f;
            border: none; color: #E8F0FE; font-size: 20px;
        }
    </style>
</head>
<body>
